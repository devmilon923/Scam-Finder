    ...
    <main className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="hidden lg:flex flex-col justify-between bg-zinc-950 p-12 text-white">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-zinc-500">Join thousands of teams already building.</p>
        </div>
      </div>
        ...
        <div className="w-full max-w-85 space-y-8">
          ...
          <div className="flex items-center gap-2 lg:hidden">
            <div className="w-7 h-7 rounded-md bg-zinc-950 dark:bg-white flex items-center justify-center">
              <span className="text-white dark:text-zinc-950 text-xs font-bold">A</span>
            </div>
          ...
          <Button
            variant="outline"
            className="w-full h-11 gap-3 rounded-xl border-zinc-200 dark:border-zinc-700 text-zinc-800 dark:text-zinc-100 text-sm font-medium hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors shadow-sm"
          ...
          <p className="text-xs text-center text-zinc-400 leading-relaxed">
            ...
            <a href="/terms" className="underline underline-offset-2 hover:text-zinc-700 dark:hover:text-zinc-200 transition-colors">
              Terms
            </a>{" "}
            and{" "}
            <a href="/privacy" className="underline underline-offset-2 hover:text-zinc-700 dark:hover:text-zinc-200 transition-colors">
              Privacy Policy
            </a>
            .
          </p>
